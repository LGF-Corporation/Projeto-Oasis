...
O projeto foi desenvolvido como trabalho acadêmico para a FIAP (2026), pela Corporação LGF.
...
É o elo entre quem precisa de ajuda e quem pode prestar socorro.
...
*quiz.html — Quiz de primeiros socorros*
Módulo educativo com perguntas sobre primeiros socorros e o Protocolo START de triagem. Pensado para preparar a comunidade local para situações de emergência como desidratação severa ou parada cardiorrespiratória.

*sobre-nos.html — Sobre a Corporação LGF*
História e propósito do grupo por trás do projeto.

*contato.html — Contato e suporte*
Formulário para reportar pontos de risco ou tirar dúvidas sobre o funcionamento das pulseiras.
...
*Acessibilidade*
Todos os elementos interativos têm estados de hover e foco com transições suaves, sem travamentos.

*Validação do quiz*
Se o usuário tentar avançar sem selecionar uma resposta, o sistema exibe um alert() bloqueando a progressão. Evita pontuações quebradas por campos vazios.
